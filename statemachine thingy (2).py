...
fileobject = open('path_data_statemachine_thingy_(2)', 'w', encoding="utf-8")
...
plt.savefig("graph_statemachine_thingy_(2)_" + str(criticaledgeprobability) + ".png")
plt.show()
...
# can you access unreachable states using the value "None"?
# can we use AtlasView to see where we are on the graph?
